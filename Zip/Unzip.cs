        ...
        /// </summary>
            ...
            public void ZipFile(string fileToZip, string zipedFile, int compressionLevel, int blockSize)
            {
                try
                {
                    ...
                    long size = streamToZip.Read(buffer, 0, buffer.Length);
            ...
            public void ZipFileFromDirectory(string rootPath, string destinationPath, int compressLevel,int blockSize=0)
            {
                try
                {
                    ...
                    */
                    ...
                    foreach (string file in files)
                    {
                        ...
                        long size = fileStream.Read(buffer, 0, buffer.Length);
                        outPutStream.PutNextEntry(entry);
                        outPutStream.Write(buffer, 0, buffer.Length);
                        try
                        {
